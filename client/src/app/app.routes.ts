...
import { AtividadesMedicasListComponent } from './components/atividades/atividades-medicas-list.component';
import { AtividadeMedicaFormComponent } from './components/atividades/atividade-medica-form.component';
...
export const routes: Routes = [
  ...
  { path: 'atividades-medicas', component: AtividadesMedicasListComponent, canActivate: [AuthGuard] },
  { path: 'atividades-medicas/new', component: AtividadeMedicaFormComponent, canActivate: [AuthGuard] },
  { path: 'atividades-medicas/edit/:id', component: AtividadeMedicaFormComponent, canActivate: [AuthGuard] },
